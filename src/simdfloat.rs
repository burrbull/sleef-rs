...
fn VOpMask vnot_vo32_vo32(VOpMask x) {
  return x ^ veq_vo_vi2_vi2(vcast_vi2_i(0), vcast_vi2_i(0));
}
#[inline]
...
#[inline]
fn visint_vo_vf(y: VFloat) -> VOpMask { return vtruncate_vf_vf(y).eq(y); }
#[inline]
fn visnumber_vo_vf(x: VFloat) -> VOpMask { return vnot_vo32_vo32(visinf_vo_vf(x) | visnan_vo_vf(x)); }

#if !defined(ENABLE_AVX512F) && !defined(ENABLE_AVX512FNOFMA)#[inline]
fn vilogbk_vi2_vf(d: VFloat) -> VInt2 {
  VOpMask o = d.lt((5.421010862427522e-20).as_vf());
  d = vsel_vf_vo_vf_vf(o, (1.8446744073709552e19).as_vf() * d, d);
...
pub fn xilogbf(d: VFloat) -> VInt2 {
  ...
  e = vsel_vi2_vo_vi2_vi2(d.eq((0.).as_vf()), vcast_vi2_i(SLEEF_FP_ILOGB0), e);
...
fn rempisubf(x: VFloat) -> (VFloat, VInt2) {
 if cfg!(feature="full_fp_rounding") {
  VFloat y = vrint_vf_vf(x * (4.).as_vf());
  VInt2 vi = vtruncate_vi2_vf(y - vrint_vf_vf(x) * (4.).as_vf());
  ( x - y * (0.25).as_vf(), vi )
 } else {
  VFloat fr = x - F1_10.as_vf() * vtruncate_vf_vf(x * (1. / F1_10).as_vf());
  VInt2 vi = vadd_vi2_vi2_vi2(vsel_vi2_vo_vi2_vi2(x.gt((0.).as_vf()), vcast_vi2_i(4), vcast_vi2_i(3)), vtruncate_vi2_vf(fr * (8.).as_vf()));
  vi = vsra_vi2_vi2_i(vsub_vi2_vi2_vi2(vand_vi2_vi2_vi2(vcast_vi2_i(7), vi), vcast_vi2_i(3)), 1);
  fr -= (0.25).as_vf() * vtruncate_vf_vf(fr.mla((4.).as_vf(), vmulsign_vf_vf_vf((0.5).as_vf(), x)));
  fr = vsel_vf_vo_vf_vf(vabs_vf_vf(fr).gt((0.25).as_vf()), fr - vmulsign_vf_vf_vf((0.5).as_vf(), x), fr);
  fr = vsel_vf_vo_vf_vf(vabs_vf_vf(fr).gt((1e+10).as_vf()), (0).as_vf(), fr);
  VOpMask o = vabs_vf_vf(x).eq((0.12499999254941940308).as_vf());
...
fn rempif(a: VFloat) -> (VFloat2, VInt2) {
  ...
  x = vsel_vf2_vo_vf2_vf2(vabs_vf_vf(a).lt((0.7).as_vf()), vcast_vf2_vf_vf(a, (0.).as_vf()), x);
  ( x, q )
}
...
pub fn xsinf(d: VFloat) -> VFloat {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX2_F.as_vf())))) {
    q = vrint_vi2_vf(d*M_1_PI_F.as_vf());
    u = vcast_vf_vi2(q);
    d = u.mla((-PI_A2_F).as_vf(), d);
    d = u.mla((-PI_B2_F).as_vf(), d);
    d = u.mla((-PI_C2_F).as_vf(), d);
  } else if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX_F.as_vf())))) {
    q = vrint_vi2_vf(d*M_1_PI_F.as_vf());
    u = vcast_vf_vi2(q);
    ...
    q = vadd_vi2_vi2_vi2(vadd_vi2_vi2_vi2(q, q), vsel_vi2_vo_vi2_vi2(dfidf.0.gt((0.).as_vf()), vcast_vi2_i(2), vcast_vi2_i(1)));
    q = vsra_vi2_vi2_i(q, 2);
    VOpMask o = veq_vo_vi2_vi2(vand_vi2_vi2_vi2(dfii, vcast_vi2_i(1)), vcast_vi2_i(1));
    VFloat2 x = vcast_vf2_vf_vf(vmulsign_vf_vf_vf((3.1415927410125732422*-0.5).as_vf(), dfidf.0), 
				vmulsign_vf_vf_vf((-8.7422776573475857731e-08*-0.5).as_vf(), dfidf.0));
...
pub fn xcosf(d: VFloat) -> VFloat {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX2_F.as_vf())))) {
    q = vrint_vi2_vf(d*M_1_PI_F.as_vf() - (0.5).as_vf());
    ...
    let (dfidf, dfii) = rempif(d);
    q = vand_vi2_vi2_vi2(dfii, vcast_vi2_i(3));
    q = vadd_vi2_vi2_vi2(vadd_vi2_vi2_vi2(q, q), vsel_vi2_vo_vi2_vi2(dfidf.0.gt((0.).as_vf()), vcast_vi2_i(8), vcast_vi2_i(7)));
    q = vsra_vi2_vi2_i(q, 1);
    VOpMask o = veq_vo_vi2_vi2(vand_vi2_vi2_vi2(dfii, vcast_vi2_i(1)), vcast_vi2_i(0));
    VFloat y = vsel_vf_vo_vf_vf(dfidf.0.gt((0.).as_vf()), (0.).as_vf(), (-1.).as_vf());
...
pub fn xtanf(d: VFloat) -> VFloat {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt((TRIGRANGEMAX2_F*0.5).as_vf())))) {
    q = vrint_vi2_vf(d * (2. * M_1_PI_F).as_vf());
    u = vcast_vf_vi2(q);
...
pub fn xsinf_u1(d: VFloat) -> VFloat {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX2_F.as_vf())))) {
    u = vrint_vf_vf(d, M_1_PI_F.as_vf());
    q = vrint_vi2_vf(u);
    v = u.mla((-PI_A2_F).as_vf(), d);
    s = dfadd2_vf2_vf_vf(v, u * (-PI_B2_F).as_vf());
    s = dfadd_vf2_vf2_vf(s, u * (-PI_C2_F).as_vf());
  } else {
    let (dfidf, dfii) = rempif(d);
    q = vand_vi2_vi2_vi2(dfii, vcast_vi2_i(3));
    q = vadd_vi2_vi2_vi2(vadd_vi2_vi2_vi2(q, q), vsel_vi2_vo_vi2_vi2(dfidf.0.gt((0.).as_vf()), vcast_vi2_i(2), vcast_vi2_i(1)));
  ...
  u = (2.6083159809786593541503e-06).as_vf()
      .mla(s.0, (-0.0001981069071916863322258).as_vf())
      .mla(s.0, (0.00833307858556509017944336).as_vf());

  x = dfadd_vf2_vf_vf2((1.).as_vf(), dfmul_vf2_vf2_vf2(dfadd_vf2_vf_vf((-0.166666597127914428710938).as_vf(), u * s.0), s));
...
pub fn xcosf_u1(d: VFloat) -> VFloat {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX2_F.as_vf())))) {
    VFloat dq = vrint_vf_vf(d.mla(M_1_PI_F.as_vf(), (-0.5).as_vf())).mla(
				 (2.).as_vf(), (1.).as_vf());
    q = vrint_vi2_vf(dq);
    s = dfadd2_vf2_vf_vf (d, dq * (-PI_A2_F*0.5).as_vf());
    s = dfadd2_vf2_vf2_vf(s, dq * (-PI_B2_F*0.5).as_vf());
    s = dfadd2_vf2_vf2_vf(s, dq * (-PI_C2_F*0.5).as_vf());
  } else {
    let (dfidf, dfii) = rempif(d);
    q = vand_vi2_vi2_vi2(dfii, vcast_vi2_i(3));
    q = vadd_vi2_vi2_vi2(vadd_vi2_vi2_vi2(q, q), vsel_vi2_vo_vi2_vi2(dfidf.0.gt((0.).as_vf()), vcast_vi2_i(8), vcast_vi2_i(7)));
...
pub fn xsincosf(d: VFloat) -> (VFloat, VFloat) {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX2_F.as_vf())))) {
    q = vrint_vi2_vf(d * M_2_PI_F.as_vf());
    u = vcast_vf_vi2(q);
...
pub fn xsincosf_u1(d: VFloat) -> (VFloat, VFloat) {
  ...
  if (LIKELY(vtestallones_i_vo32(vabs_vf_vf(d).lt(TRIGRANGEMAX2_F.as_vf())))) {
    u = vrint_vf_vf(d * (2. * M_1_PI_F).as_vf());
    q = vrint_vi2_vf(u);
    v = u.mla((-PI_A2_F*0.5).as_vf(), d);
    s = dfadd2_vf2_vf_vf(v, u * (-PI_B2_F*0.5).as_vf());
    s = dfadd_vf2_vf2_vf(s, u * (-PI_C2_F*0.5).as_vf());
  } else {
    let (dfidf, dfii) = rempif(d);
    q = dfii;
    s = dfidf;
  ...
  u = (-0.000195169282960705459117889).as_vf()
      .mla(s.0, (0.00833215750753879547119141).as_vf())
      .mla(s.0, (-0.166666537523269653320312).as_vf());
  ...
  u = (-2.71811842367242206819355e-07).as_vf()
      .mla(s.0, (2.47990446951007470488548e-05).as_vf())
      .mla(s.0, (-0.00138888787478208541870117).as_vf())
      .mla(s.0, (0.0416666641831398010253906).as_vf())
      .mla(s.0, (-0.5).as_vf());

  x = dfadd_vf2_vf_vf2((1.).as_vf(), dfmul_vf2_vf_vf(s.0, u));
  ry = x.0 + x.1;
...
pub fn xsincospif_u05(d: VFloat) -> (VFloat, VFloat) {
  ...
  x = dfadd2_vf2_vf_vf2(u * s, vcast_vf2_f_f(-0.080745510756969451904, -1.3373665339076936258e-09));
  ...
  x = dfadd2_vf2_vf_vf2(u * s, vcast_vf2_f_f(0.015854343771934509277, 4.4940051354032242811e-10));
...
pub fn xsincospif_u35(d: VFloat) -> (VFloat, VFloat) {
  ...
  o = veq_vo_vi2_vi2(vand_vi2_vi2_vi2(q, vcast_vi2_i(4)), vcast_vi2_i(4));
  r.0 = vreinterpret_vf_vm(vxor_vm_vm_vm(vand_vm_vo32_vm(o, vreinterpret_vm_vf((-0.).as_vf())), vreinterpret_vm_vf(r.0)));

  o = veq_vo_vi2_vi2(vand_vi2_vi2_vi2(vadd_vi2_vi2_vi2(q, vcast_vi2_i(2)), vcast_vi2_i(4)), vcast_vi2_i(4));
  r.1 = vreinterpret_vf_vm(vxor_vm_vm_vm(vand_vm_vo32_vm(o, vreinterpret_vm_vf((-0.).as_vf())), vreinterpret_vm_vf(r.1)));
...
pub fn xmodff(x: VFloat) -> (VFloat, VFloat) {
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  fr = vsel_vf_vo_vf_vf(vabs_vf_vf(x).gt(F1_23.as_vf()), (0.).as_vf(), fr);
...
pub fn xtanf_u1(d: VFloat) -> VFloat {
  ...
  u = (0.00446636462584137916564941).as_vf()
      .mla(s.0, (-8.3920182078145444393158e-05).as_vf())
      .mla(s.0, (0.0109639242291450500488281).as_vf())
      .mla(s.0, (0.0212360303848981857299805).as_vf())
      .mla(s.0, (0.0540687143802642822265625).as_vf());

  x = dfadd_vf2_vf_vf((0.133325666189193725585938).as_vf(), u * s.0);
...
pub fn xatanf(d: VFloat) -> VFloat {
  ...
  s = vsel_vf_vo_vf_vf((1.).as_vf().lt(s), vrec_vf_vf(s), s);
  ...
  t = vsel_vf_vo_vf_vf(veq_vo_vi2_vi2(vand_vi2_vi2_vi2(q, vcast_vi2_i(1)), vcast_vi2_i(1)), (M_PI_F/2.).as_vf() - t, t);
...
pub fn xatan2f(y: VFloat, x: VFloat) -> VFloat {
  ...
  r = vsel_vf_vo_vf_vf(visinf_vo_vf(x) | x.eq((0.).as_vf()), (M_PI_F/2.).as_vf() - visinf2_vf_vf_vf(x, vmulsign_vf_vf_vf((M_PI_F/2.).as_vf(), x)), r);
  r = vsel_vf_vo_vf_vf(visinf_vo_vf(y), (M_PI_F/2.).as_vf() - visinf2_vf_vf_vf(x, vmulsign_vf_vf_vf((M_PI_F/4.).as_vf(), x)), r);

  r = vsel_vf_vo_vf_vf(y.eq((0.).as_vf()), vreinterpret_vf_vm(vand_vm_vo32_vm(vsignbit_vo_vf(x), vreinterpret_vm_vf(M_PI_F.as_vf()))), r);
...
pub fn xasinf(d: VFloat) -> VFloat {
  VOpMask o = vabs_vf_vf(d).lt((0.5).as_vf());
  VFloat x2 = vsel_vf_vo_vf_vf(o, d * d, ((1.).as_vf() - vabs_vf_vf(d)) * (0.5).as_vf());
...
pub fn xacosf(d: VFloat) -> VFloat {
  VOpMask o = vabs_vf_vf(d).lt((0.5).as_vf());
  VFloat x2 = vsel_vf_vo_vf_vf(o, d * d,
				((1.).as_vf() - vabs_vf_vf(d)) * (0.5).as_vf()), u;
  VFloat x = vsel_vf_vo_vf_vf(o, vabs_vf_vf(d), vsqrt_vf_vf(x2));
  x = vsel_vf_vo_vf_vf(vabs_vf_vf(d).eq((1.).as_vf()), (0.).as_vf(), x);
  ...
  VFloat y = (3.1415926535897932/2.).as_vf() - (vmulsign_vf_vf_vf(x, d) + vmulsign_vf_vf_vf(u, d));
  x = x + u;
  VFloat r = vsel_vf_vo_vf_vf(o, y, x * (2.).as_vf());
  return vsel_vf_vo_vf_vf(vandnot_vo_vo_vo(o, d.lt((0.).as_vf())),
...
fn atan2kf_u1(VFloat2 y, VFloat2 x) -> VFloat2 {
  ...
  q = vsel_vi2_vf_vf_vi2_vi2(x.0, (0.).as_vf(), vcast_vi2_i(-2), vcast_vi2_i(0));
  p = x.0.lt((0.).as_vf());
  ...
  q = vsel_vi2_vf_vf_vi2_vi2(x.0, y.0, vadd_vi2_vi2_vi2(q, vcast_vi2_i(1)), q);
  p = x.0.lt(y.0);
  ...
  u = (-0.00176397908944636583328247).as_vf()
      .mla(t.0, (0.0107900900766253471374512).as_vf())
      .mla(t.0, (-0.0309564601629972457885742).as_vf())
      .mla(t.0, (0.0577365085482597351074219).as_vf())
      .mla(t.0, (-0.0838950723409652709960938).as_vf())
      .mla(t.0, (0.109463557600975036621094).as_vf())
      .mla(t.0, (-0.142626821994781494140625).as_vf())
      .mla(t.0, (0.199983194470405578613281).as_vf());

  t = dfmul_vf2_vf2_vf2(t, dfadd_vf2_vf_vf((-0.333332866430282592773438).as_vf(), u * t.0));
...
pub fn xatan2f_u1(y: VFloat, x: VFloat) -> VFloat {
  VOpMask o = vabs_vf_vf(x).lt((2.9387372783541830947e-39).as_vf()); // nexttowardf((1.0 / FLT_MAX), 1)
  x = vsel_vf_vo_vf_vf(o, x * F1_24.as_vf(), x);
  y = vsel_vf_vo_vf_vf(o, y * F1_24.as_vf(), y);
...
pub fn xasinf_u1(d: VFloat) -> VFloat {
  VOpMask o = vabs_vf_vf(d).lt((0.5).as_vf());
  VFloat x2 = vsel_vf_vo_vf_vf(o, d * d, ((1.).as_vf() - vabs_vf_vf(d)) * (0.5).as_vf()), u;
  VFloat2 x = vsel_vf2_vo_vf2_vf2(o, vcast_vf2_vf_vf(vabs_vf_vf(d), (0.).as_vf()), dfsqrt_vf2_vf(x2));
  x = vsel_vf2_vo_vf2_vf2(vabs_vf_vf(d).eq((1.).as_vf()), vcast_vf2_f_f(0, 0), x);
  ...
  VFloat r = vsel_vf_vo_vf_vf(o, u + x.0,
			       (y.0 + y.1) * (2.).as_vf());
  return vmulsign_vf_vf_vf(r, d);
}
...
pub fn xacosf_u1(d: VFloat) -> VFloat {
  ...
  y = vsel_vf2_vo_vf2_vf2(vandnot_vo_vo_vo(o, d.lt((0.).as_vf())),
...
pub fn xlogf(d: VFloat) -> VFloat {
  ...
  VOpMask o = d.lt(f32::MIN.as_vf());
  d = vsel_vf_vo_vf_vf(o, d * (F1_32 * F1_32).as_vf(), d);
  VInt2 e = vilogb2k_vi2_vf(d * (1./0.75).as_vf());
  m = vldexp3_vf_vf_vi2(d, vneg_vi2_vi2(e));
  e = vsel_vi2_vo_vi2_vi2(o, vsub_vi2_vi2_vi2(e, vcast_vi2_i(64)), e);
#else
  VFloat e = vgetexp_vf_vf(d * (1./0.75).as_vf());
  e = vsel_vf_vo_vf_vf(vispinf_vo_vf(e), (128.).as_vf(), e);
  m = vgetmant_vf_vf(d);
#endif
  
  x = ((-1.).as_vf() + m) / ((1.).as_vf() + m);
  x2 = x * x;
...
#if !defined(ENABLE_AVX512F) && !defined(ENABLE_AVX512FNOFMA)
  x = x.mla(t, (0.693147180559945286226764).as_vf() * vcast_vf_vi2(e));
  x = vsel_vf_vo_vf_vf(vispinf_vo_vf(d), SLEEF_INFINITY_F.as_vf(), x);
  x = vsel_vf_vo_vf_vf(d.lt((0.).as_vf()) | visnan_vo_vf(d), SLEEF_NAN_F.as_vf(), x);
  x = vsel_vf_vo_vf_vf(d.eq((0.).as_vf()), (-SLEEF_INFINITY_F).as_vf(), x);
#else
  x = x.mla(t, (0.693147180559945286226764).as_vf() * e);
...
pub fn xexpf(d: VFloat) -> VFloat {
  VInt2 q = vrint_vi2_vf(d * R_LN2_F.as_vf());
  VFloat s, u;
  ...
  u = (1.).as_vf() + (s * s).mla(u, s);

  u = vldexp2_vf_vf_vi2(u, q);

  u = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.lt((-104.).as_vf()), vreinterpret_vm_vf(u)));
  u = vsel_vf_vo_vf_vf((100.).as_vf().lt(d), SLEEF_INFINITY_F.as_vf(), u);
...
fn expm1fk(d: VFloat) -> VFloat {
  ...
  u = vsel_vf_vo_vf_vf(veq_vo_vi2_vi2(q, vcast_vi2_i(0)), u,
		       vldexp2_vf_vf_vi2(u + (1.).as_vf(), q) - (1.).as_vf());
...
pub fn xsqrtf_u35(d: VFloat) -> VFloat {
  ...
  e = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.eq((0.).as_vf()), vreinterpret_vm_vf(e)));
  u = e * u;

  u = vsel_vf_vo_vf_vf(visinf_vo_vf(d), SLEEF_INFINITY_F.as_vf(), u);
  u = vreinterpret_vf_vm(vor_vm_vo32_vm(visnan_vo_vf(d) | d.lt((0.).as_vf()), vreinterpret_vm_vf(u)));
...
pub fn xcbrtf(d: VFloat) -> VFloat {
  ...
  t = vcast_vf_vi2(e) + (6144.).as_vf();
  qu = vtruncate_vi2_vf(t * (1./3.).as_vf());
  re = vtruncate_vi2_vf(t - vcast_vf_vi2(qu) * (3.).as_vf());
  ...
  y = d * x * x;
  y = (y - (2. / 3.).as_vf() * y * y.mla(x, (-1.).as_vf())) * q;

#if defined(ENABLE_AVX512F) || defined(ENABLE_AVX512FNOFMA)
  y = vsel_vf_vo_vf_vf(visinf_vo_vf(s), vmulsign_vf_vf_vf(SLEEF_INFINITY_F.as_vf(), s), y);
  y = vsel_vf_vo_vf_vf(s.eq((0.).as_vf()), vmulsign_vf_vf_vf((0.).as_vf(), s), y);
#endif
...
pub fn xcbrtf_u1(d: VFloat) -> VFloat {
  ...
  y = x * x;
  y = y * y;
  x -= vmlanp_vf_vf_vf_vf(d, y, x) * (-1. / 3.).as_vf();
  ...
  z = vldexp2_vf_vf_vi2(v.0 + v.1, vsub_vi2_vi2_vi2(qu, vcast_vi2_i(2048)));

  z = vsel_vf_vo_vf_vf(visinf_vo_vf(d), vmulsign_vf_vf_vf(SLEEF_INFINITY_F.as_vf(), q2.0), z);
  z = vsel_vf_vo_vf_vf(d.eq((0.).as_vf()), vreinterpret_vf_vm(vsignbit_vm_vf(q2.0)), z);

#if defined(ENABLE_AVX512F) || defined(ENABLE_AVX512FNOFMA)
  z = vsel_vf_vo_vf_vf(visinf_vo_vf(s), vmulsign_vf_vf_vf(SLEEF_INFINITY_F.as_vf(), s), z);
  z = vsel_vf_vo_vf_vf(s.eq((0.).as_vf()), vmulsign_vf_vf_vf((0.).as_vf(), s), z);
#endif
...
fn logkf(d: VFloat) -> VFloat2 {
  ...
  t = (0.240320354700088500976562).as_vf()
      .mla(x2.0, (0.285112679004669189453125).as_vf())
      .mla(x2.0, (0.400007992982864379882812).as_vf());
...
pub fn xlogf_u1(d: VFloat) -> VFloat {
  ...
  r = vsel_vf_vo_vf_vf(d.lt((0.).as_vf()) | visnan_vo_vf(d), SLEEF_NAN_F.as_vf(), r);
  r = vsel_vf_vo_vf_vf(d.eq((0.).as_vf()), (-SLEEF_INFINITY_F).as_vf(), r);
#else
...
fn expkf(VFloat2 d) -> VFloat {
  VFloat u = (d.0 + d.1) * R_LN2_F.as_vf();
  VInt2 q = vrint_vi2_vf(u);
  VFloat2 s, t;

  s = dfadd2_vf2_vf2_vf(d, vcast_vf_vi2(q) * (-L2U_F).as_vf());
  s = dfadd2_vf2_vf2_vf(s, vcast_vf_vi2(q) * (-L2L_F).as_vf());

  s = dfnormalize_vf2_vf2(s);

  u = (0.00136324646882712841033936).as_vf()
      .mla(s.0, (0.00836596917361021041870117).as_vf())
      .mla(s.0, (0.0416710823774337768554688).as_vf())
      .mla(s.0, (0.166665524244308471679688).as_vf())
      .mla(s.0, (0.499999850988388061523438).as_vf());
  ...
  u = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.0.lt((-104.).as_vf()), vreinterpret_vm_vf(u)));
...
pub fn xpowf(x: VFloat, y: VFloat) -> VFloat {
#if 1
  VOpMask yisint = vtruncate_vf_vf(y).eq(y) | vabs_vf_vf(y).gt(F1_24.as_vf());
  VOpMask yisodd = veq_vo_vi2_vi2(vand_vi2_vi2_vi2(vtruncate_vi2_vf(y), vcast_vi2_i(1)), vcast_vi2_i(1)) & yisint &
				 vabs_vf_vf(y).lt(F1_24.as_vf());
  ...
  result *= vsel_vf_vo_vf_vf(x.gt((0.).as_vf()),
					  (1.).as_vf(),
					  vsel_vf_vo_vf_vf(yisint, vsel_vf_vo_vf_vf(yisodd, (-1.).as_vf(), (1.).as_vf()), SLEEF_NAN_F.as_vf()));

  VFloat efx = vmulsign_vf_vf_vf(vabs_vf_vf(x) - (1.).as_vf(), y);

  result = vsel_vf_vo_vf_vf(visinf_vo_vf(y),
			    vreinterpret_vf_vm(vandnot_vm_vo32_vm(efx.lt((0.).as_vf()),
								  vreinterpret_vm_vf(vsel_vf_vo_vf_vf(efx.eq((0.).as_vf()),
												      (1.).as_vf(),
												      SLEEF_INFINITY_F.as_vf())))),
			    result);

  result = vsel_vf_vo_vf_vf(visinf_vo_vf(x) | x.eq((0.).as_vf()),
			    vsel_vf_vo_vf_vf(yisodd, vsign_vf_vf(x), (1.).as_vf()) *
					  vreinterpret_vf_vm(vandnot_vm_vo32_vm(vsel_vf_vo_vf_vf(x.eq((0.).as_vf()), -y, y).lt((0.).as_vf()),
  ...
  result = vsel_vf_vo_vf_vf(y.eq((0.).as_vf()) | x.eq((1.).as_vf()), (1.).as_vf(), result);
...
fn expk2f(VFloat2 d) -> VFloat2 {
  ...
  u = (+0.1980960224e-3).as_vf()
      .mla(s.0, (+0.1394256484e-2).as_vf())
      .mla(s.0, (+0.8333456703e-2).as_vf())
      .mla(s.0, (+0.4166637361e-1).as_vf());
  ...
  t.0 = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.0.lt((-104.).as_vf()), vreinterpret_vm_vf(t.0)));
  t.1 = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.0.lt((-104.).as_vf()), vreinterpret_vm_vf(t.1)));
...
pub fn xsinhf(x: VFloat) -> VFloat {
  ...
  y = vsel_vf_vo_vf_vf(vabs_vf_vf(x).gt((89.).as_vf()) |
...
pub fn xtanhf(x: VFloat) -> VFloat {
  ...
  y = vsel_vf_vo_vf_vf(vabs_vf_vf(x).gt((8.664339742).as_vf()) |
...
pub fn xsinhf_u35(x: VFloat) -> VFloat {
  ...
  VFloat y = (e + (2.).as_vf()) / (e + (1.).as_vf());
  y *= (0.5).as_vf() * e;

  y = vsel_vf_vo_vf_vf(vabs_vf_vf(x).gt((88.).as_vf()) |
				    visnan_vo_vf(y), SLEEF_INFINITY_F.as_vf(), y);
  y = vmulsign_vf_vf_vf(y, x);
  y = vreinterpret_vf_vm(vor_vm_vo32_vm(visnan_vo_vf(x), vreinterpret_vm_vf(y)));
...
pub fn xcoshf_u35(x: VFloat) -> VFloat {
  ...
  VFloat y = (0.5).as_vf().mla(e, (0.5).as_vf() / e);
...
pub fn xtanhf_u35(x: VFloat) -> VFloat {
  VFloat d = expm1fk((2.).as_vf() * vabs_vf_vf(x));
  VFloat y = d / ((2.).as_vf() + d);
...
fn logk2f(VFloat2 d) -> VFloat2 {
...
#if !defined(ENABLE_AVX512F) && !defined(ENABLE_AVX512FNOFMA)
  e = vilogbk_vi2_vf(d.0 * (1./0.75).as_vf());
#else
  e = vrint_vi2_vf(vgetexp_vf_vf(d.0 * (1./0.75).as_vf()));
#endif
  ...
  t = (0.2392828464508056640625).as_vf()
      .mla(x2.0, (0.28518211841583251953125).as_vf())
      .mla(x2.0, (0.400005877017974853515625).as_vf())
      .mla(x2.0, (0.666666686534881591796875).as_vf());
...
pub fn xasinhf(x: VFloat) -> VFloat {
  ...
  y = vsel_vf_vo_vf_vf(vabs_vf_vf(x).gt(SQRT_FLT_MAX.as_vf()) |
				    visnan_vo_vf(y),
...
pub fn xacoshf(x: VFloat) -> VFloat {
  ...
  y = vreinterpret_vf_vm(vandnot_vm_vo32_vm(x.eq((1.).as_vf()), vreinterpret_vm_vf(y)));

  y = vreinterpret_vf_vm(vor_vm_vo32_vm(x.lt((1.).as_vf()), vreinterpret_vm_vf(y)));
  y = vreinterpret_vf_vm(vor_vm_vo32_vm(visnan_vo_vf(x), vreinterpret_vm_vf(y)));
...
pub fn xatanhf(x: VFloat) -> VFloat {
  VFloat y = vabs_vf_vf(x);
  VFloat2 d = logk2f(dfdiv_vf2_vf2_vf2(dfadd2_vf2_vf_vf((1.).as_vf(), y), dfadd2_vf2_vf_vf((1.).as_vf(), -y)));
  y = vreinterpret_vf_vm(vor_vm_vo32_vm(y.gt((1.).as_vf()), vreinterpret_vm_vf(vsel_vf_vo_vf_vf(y.eq((1.).as_vf()), SLEEF_INFINITY_F.as_vf(), (d.0 + d.1) * (0.5).as_vf()))));
...
#else
  u = dfnormalize_vf2_vf2(dfadd_vf2_vf_vf2((1.).as_vf(), dfmul_vf2_vf_vf(u, s))).0;
#endif
  
  u = vldexp2_vf_vf_vi2(u, q);

  u = vsel_vf_vo_vf_vf(d.ge((128.).as_vf()), SLEEF_INFINITY.as_vf(), u);
  u = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.lt((-150.).as_vf()), vreinterpret_vm_vf(u)));

  return u;
}

pub fn xexp10f(d: VFloat) -> VFloat {
  VFloat u = vrint_vf_vf(d * LOG10_2.as_vf()), s;
  VInt2 q = vrint_vi2_vf(u);
  ...
  u = vsel_vf_vo_vf_vf(d.gt((38.5318394191036238941387).as_vf()), SLEEF_INFINITY_F.as_vf(), u);
  u = vreinterpret_vf_vm(vandnot_vm_vo32_vm(d.lt((-50.).as_vf()), vreinterpret_vm_vf(u)));
...
pub fn xexpm1f(a: VFloat) -> VFloat {
  ...
  VFloat x = d.0 + d.1;
  x = vsel_vf_vo_vf_vf(a.gt((88.72283172607421875).as_vf()), SLEEF_INFINITY_F.as_vf(), x);
  x = vsel_vf_vo_vf_vf(a.lt((-16.635532333438687426013570).as_vf()), (-1.).as_vf(), x);
...
pub fn xlog10f(d: VFloat) -> VFloat {
  ...
  r = vsel_vf_vo_vf_vf(d.lt((0.).as_vf()) | visnan_vo_vf(d), SLEEF_NAN.as_vf(), r);
  r = vsel_vf_vo_vf_vf(d.eq((0.).as_vf()), (-SLEEF_INFINITY).as_vf(), r);
#else
  r = vfixup_vf_vf_vf_vi2_i(r, d, vcast_vi2_i((4 << (2*4)) | (3 << (4*4)) | (5 << (5*4)) | (2 << (6*4))), 0);
#endif
...
pub fn xlog1pf(d: VFloat) -> VFloat {
  ...
  VFloat dp1 = d + (1.).as_vf();

#if !defined(ENABLE_AVX512F) && !defined(ENABLE_AVX512FNOFMA)
  VOpMask o = dp1.lt(f32::MIN.as_vf());
  dp1 = vsel_vf_vo_vf_vf(o, dp1 * (F1_32 * F1_32).as_vf(), dp1);
  VInt2 e = vilogb2k_vi2_vf(dp1 * (1./0.75).as_vf());
  t = vldexp3_vf_vf_vi2((1.).as_vf(), vneg_vi2_vi2(e));
  m = d.mla(t, t - (1.).as_vf());
  e = vsel_vi2_vo_vi2_vi2(o, vsub_vi2_vi2_vi2(e, vcast_vi2_i(64)), e);
  VFloat2 s = dfmul_vf2_vf2_vf(vcast_vf2_f_f(0.69314718246459960938, -1.904654323148236017e-09), vcast_vf_vi2(e));
#else
  VFloat e = vgetexp_vf_vf(dp1, (1./0.75).as_vf());
  e = vsel_vf_vo_vf_vf(vispinf_vo_vf(e), (128.).as_vf(), e);
  ...
  r = vsel_vf_vo_vf_vf(d.gt((1e+38).as_vf()), SLEEF_INFINITY_F.as_vf(), r);
  r = vreinterpret_vf_vm(vor_vm_vo32_vm((-1.).as_vf().gt(d), vreinterpret_vm_vf(r)));
  r = vsel_vf_vo_vf_vf(d.eq((-1.).as_vf()), (-SLEEF_INFINITY_F).as_vf(), r);
...
pub fn xfdimf(x: VFloat, y: VFloat) -> VFloat {
  VFloat ret = x - y;
  ret = vsel_vf_vo_vf_vf(ret.lt((0.).as_vf()) | x.eq(y), (0.).as_vf(), ret);
  return ret;
}

pub fn xtruncf(x: VFloat) -> VFloat {
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  return vsel_vf_vo_vf_vf(visinf_vo_vf(x) | vabs_vf_vf(x).ge(F1_23.as_vf()), x, vcopysign_vf_vf_vf(x - fr, x));
}

pub fn xfloorf(x: VFloat) -> VFloat {
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  fr = vsel_vf_vo_vf_vf(fr.lt((0.).as_vf()), fr + (1.).as_vf(), fr);
  return vsel_vf_vo_vf_vf(visinf_vo_vf(x) | vabs_vf_vf(x).ge(F1_23.as_vf()), x, vcopysign_vf_vf_vf(x - fr, x));
}

pub fn xceilf(x: VFloat) -> VFloat {
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  fr = vsel_vf_vo_vf_vf(fr.le((0.).as_vf()), fr, fr - (1.).as_vf());
  return vsel_vf_vo_vf_vf(visinf_vo_vf(x) | vabs_vf_vf(x).ge(F1_23.as_vf()), x, vcopysign_vf_vf_vf(x - fr, x));
}

pub fn xroundf(d: VFloat) -> VFloat {
  VFloat x = d + (0.5).as_vf();
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  x = vsel_vf_vo_vf_vf(x.le((0.).as_vf()) & fr.eq((0.).as_vf()), x - (1.).as_vf(), x);
  fr = vsel_vf_vo_vf_vf(fr.lt((0.).as_vf()), fr + (1.).as_vf(), fr);
  x = vsel_vf_vo_vf_vf(d.eq((0.4999999701976776123).as_vf()), (0.).as_vf(), x);
  return vsel_vf_vo_vf_vf(visinf_vo_vf(d) | vabs_vf_vf(d).ge(F1_23.as_vf()), d, vcopysign_vf_vf_vf(x - fr, d));
}
...
pub fn xrintf(d: VFloat) -> VFloat {
  ...
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  fr = vsel_vf_vo_vf_vf(fr.lt((0.).as_vf()) | (fr.eq((0.).as_vf()) & isodd), fr + (1.).as_vf(), fr);
  x = vsel_vf_vo_vf_vf(d.eq((0.50000005960464477539).as_vf()), (0.).as_vf(), x);
  VFloat ret = vsel_vf_vo_vf_vf(visinf_vo_vf(d) | vabs_vf_vf(d).ge(F1_23.as_vf()), d, vcopysign_vf_vf_vf(x - fr, d));
  return ret;
}
...
pub fn xfmaf(VFloat x, VFloat y, VFloat z) -> VFloat {
  VFloat h2 = x * y + z;
   q = (1.).as_vf();
  VOpMask o = vabs_vf_vf(h2).lt((1e-38).as_vf());
  {
    const float c0 = 1ULL << 25, c1 = c0 * c0, c2 = c1 * c1;
    x = vsel_vf_vo_vf_vf(o, x * c1.as_vf(), x);
    y = vsel_vf_vo_vf_vf(o, y * c1.as_vf(), y);
    z = vsel_vf_vo_vf_vf(o, z * c2.as_vf(), z);
    q = vsel_vf_vo_vf_vf(o, (1. / c2).as_vf(), q);
  }
  o = vabs_vf_vf(h2).gt((1e+38).as_vf());
  {
    const float c0 = 1ULL << 25, c1 = c0 * c0, c2 = c1 * c1;
    x = vsel_vf_vo_vf_vf(o, x * (1. / c1).as_vf(), x);
    y = vsel_vf_vo_vf_vf(o, y * (1. / c1).as_vf(), y);
    z = vsel_vf_vo_vf_vf(o, z * (1. / c2).as_vf(), z);
    q = vsel_vf_vo_vf_vf(o, c2.as_vf(), q);
  }
  VFloat2 d = dfmul_vf2_vf_vf(x, y);
  d = dfadd2_vf2_vf2_vf(d, z);
  VFloat ret = vsel_vf_vo_vf_vf(x.eq((0.).as_vf()) | y.eq((0.).as_vf()), z, d.0 + d.1);
  o = visinf_vo_vf(z);
...
SQRTFU05_FUNCATR VFloat xsqrtf_u05(d: VFloat) {
  ...
  d = vsel_vf_vo_vf_vf(d.lt((0.).as_vf()), SLEEF_NAN_F.as_vf(), d);

  o = d.lt((5.2939559203393770e-23).as_vf());
  d = vsel_vf_vo_vf_vf(o, d * (1.8889465931478580e+22).as_vf(), d);
  q = vsel_vf_vo_vf_vf(o, (7.2759576141834260e-12*0.5).as_vf(), (0.5).as_vf());

  o = d.gt((1.8446744073709552e+19).as_vf());
  d = vsel_vf_vo_vf_vf(o, d * (5.4210108624275220e-20).as_vf(), d);
  q = vsel_vf_vo_vf_vf(o, (4294967296.0 * 0.5).as_vf(), q);

  VFloat x = vreinterpret_vf_vi2(vsub_vi2_vi2_vi2(vcast_vi2_i(0x5f375a86), vsrl_vi2_vi2_i(vreinterpret_vi2_vf(d + (1e-45).as_vf()), 1)));

  x *= (1.5).as_vf() - (0.5).as_vf() * d * x * x;
  x *= (1.5).as_vf() - (0.5).as_vf() * d * x * x;
  x *= (1.5).as_vf() - (0.5).as_vf() * d * x * x;
  x *= d;
  ...
  x = vsel_vf_vo_vf_vf(vispinf_vo_vf(d), SLEEF_INFINITY_F.as_vf(), x);
  x = vsel_vf_vo_vf_vf(d.eq((0.).as_vf()), d, x);
...
pub fn xhypotf_u05(x: VFloat, y: VFloat) -> VFloat {
  ...
  VOpMask o = max.lt(f32::MIN.as_vf());
  n = vsel_vf_vo_vf_vf(o, n * F1_24.as_vf(), n);
  d = vsel_vf_vo_vf_vf(o, d * F1_24.as_vf(), d);
  ...
  ret = vsel_vf_vo_vf_vf(min.eq((0.).as_vf()), max, ret);
  ret = vsel_vf_vo_vf_vf(visnan_vo_vf(x) | visnan_vo_vf(y), SLEEF_NAN_F.as_vf(), ret);
  ret = vsel_vf_vo_vf_vf(x.eq(SLEEF_INFINITY_F.as_vf()) | y.eq(SLEEF_INFINITY_F.as_vf()), SLEEF_INFINITY_F.as_vf(), ret);
...
pub fn xhypotf_u35(x: VFloat, y: VFloat) -> VFloat {
  ...
  VFloat t = min / max;
  VFloat ret = max * vsqrt_vf_vf(t.mla(t, (1.).as_vf()));
  ret = vsel_vf_vo_vf_vf(min.eq((0.).as_vf()), max, ret);
  ret = vsel_vf_vo_vf_vf(visnan_vo_vf(x) | visnan_vo_vf(y), SLEEF_NAN_F.as_vf(), ret);
  ret = vsel_vf_vo_vf_vf(x.eq(SLEEF_INFINITY_F.as_vf()) | y.eq(SLEEF_INFINITY_F.as_vf()), SLEEF_INFINITY_F.as_vf(), ret);
...
pub fn xnextafterf(x: VFloat, y: VFloat) -> VFloat {
  x = vsel_vf_vo_vf_vf(x.eq((0.).as_vf()), vmulsign_vf_vf_vf((0.).as_vf(), y), x);
  VInt2 t, xi2 = vreinterpret_vi2_vf(x);
  VOpMask c = vsignbit_vo_vf(x) ^ y.ge(x);

  xi2 = vsel_vi2_vo_vi2_vi2(c, vsub_vi2_vi2_vi2(vcast_vi2_i(0), vxor_vi2_vi2_vi2(xi2, vcast_vi2_i(1 << 31))), xi2);

  xi2 = vsel_vi2_vo_vi2_vi2(x.ne(y), vsub_vi2_vi2_vi2(xi2, vcast_vi2_i(1)), xi2);

  xi2 = vsel_vi2_vo_vi2_vi2(c, vsub_vi2_vi2_vi2(vcast_vi2_i(0), vxor_vi2_vi2_vi2(xi2, vcast_vi2_i(1 << 31))), xi2);

  VFloat ret = vreinterpret_vf_vi2(xi2);

  ret = vsel_vf_vo_vf_vf(ret.eq((0.).as_vf()) & x.ne((0.).as_vf()), 
			 vmulsign_vf_vf_vf((0.).as_vf(), x), ret);

  ret = vsel_vf_vo_vf_vf(x.eq((0.).as_vf()) & y.eq((0.).as_vf()), y, ret);
...
pub fn xfrfrexpf(x: VFloat) -> VFloat {
  x = vsel_vf_vo_vf_vf(vabs_vf_vf(x).lt(f32::MIN.as_vf()), x * F1_32.as_vf(), x);
  ...
  ret = vsel_vf_vo_vf_vf(x.eq((0.).as_vf()), x, ret);
...
pub fn xexpfrexpf(x: VFloat) -> VInt2 {
  /*
  x = vsel_vf_vo_vf_vf(vabs_vf_vf(x).lt(f32::MIN.as_vf()), x * F1_63.as_vf(), x);

  let ret = vreinterpret_vi2_vf(x).as_vi();
  ret = vand_vi_vi_vi(vsrl_vi_vi_i(ret, 20), (0x7ff).as_vi()) - (0x3fe).as_vi();

  ret = vsel_vi_vo_vi_vi(x.eq((0.).as_vf()) | visnan_vo_vf(x) | visinf_vo_vf(x), (0).as_vi(), ret);
...
fn vtoward0f(x: VFloat) -> VFloat {
  ...
  return vsel_vf_vo_vf_vf(x.eq((0.).as_vf()), (0.).as_vf(), t);
}
#[inline]
...
#else
  VFloat fr = x - vcast_vf_vi2(vtruncate_vi2_vf(x));
  return vsel_vf_vo_vf_vf(vabs_vf_vf(x).ge(F1_23.as_vf()), x, x - fr);
#endif
}

pub fn xfmodf(x: VFloat, y: VFloat) -> VFloat {
  VFloat nu = vabs_vf_vf(x), de = vabs_vf_vf(y), s = (1.).as_vf(), q;
  VOpMask o = de.lt(f32::MIN.as_vf());
  nu = vsel_vf_vo_vf_vf(o, nu * F1_25.as_vf(), nu);
  de = vsel_vf_vo_vf_vf(o, de * F1_25.as_vf(), de);
  s  = vsel_vf_vo_vf_vf(o, s * (1. / F1_25).as_vf(), s);
...
fn sinpifk(d: VFloat) -> VFloat2 {
  ...
  o = veq_vo_vi2_vi2(vand_vi2_vi2_vi2(q, vcast_vi2_i(4)), vcast_vi2_i(4));
  x.0 = vreinterpret_vf_vm(vxor_vm_vm_vm(vand_vm_vo32_vm(o, vreinterpret_vm_vf((-0.).as_vf())), vreinterpret_vm_vf(x.0)));
  x.1 = vreinterpret_vf_vm(vxor_vm_vm_vm(vand_vm_vo32_vm(o, vreinterpret_vm_vf((-0.).as_vf())), vreinterpret_vm_vf(x.1)));
...
pub fn xsinpif_u05(d: VFloat) -> VFloat {
  ...
  r = vsel_vf_vo_vf_vf(visnegzero_vo_vf(d), (-0.).as_vf(), r);
  r = vreinterpret_vf_vm(vandnot_vm_vo32_vm(vabs_vf_vf(d).gt(TRIGRANGEMAX4_F.as_vf()), vreinterpret_vm_vf(r)));
...
pub fn xcospif_u05(d: VFloat) -> VFloat {
  ...
  r = vsel_vf_vo_vf_vf(vabs_vf_vf(d).gt(TRIGRANGEMAX4_F.as_vf()), (1.).as_vf(), r);
  r = vreinterpret_vf_vm(vor_vm_vo32_vm(visinf_vo_vf(d), vreinterpret_vm_vf(r)));
...
static CONST df2 gammafk(a: VFloat) {
  ...
  VOpMask otiny = vabs_vf_vf(a).lt((1e-30).as_vf()), oref = a.lt((0.5).as_vf());

  x = vsel_vf2_vo_vf2_vf2(otiny, vcast_vf2_f_f(0, 0),
			  vsel_vf2_vo_vf2_vf2(oref, dfadd2_vf2_vf_vf((1.).as_vf(), -a),
					      vcast_vf2_vf_vf(a, (0.).as_vf())));

  VOpMask o0 = (0.5).as_vf().le(x.0) & x.0.le((1.2).as_vf());
  VOpMask o2 = (2.3).as_vf().le(x.0);
  ...
  if (!vtestallones_i_vo32(vnot_vo32_vo32(oref))) {
    t = a - F1_12.as_vf() * vcast_vf_vi2(vtruncate_vi2_vf(a * (1. / F1_12).as_vf()));
    x = dfmul_vf2_vf2_vf2(clld, sinpifk(t));
  }
  
  clld = vsel_vf2_vo_vf2_vf2(otiny, vcast_vf2_vf_vf(a * (F1_30*F1_30).as_vf(), (0.).as_vf()),
...
pub fn xtgammaf_u1(a: VFloat) -> VFloat {
  ...
  o = a.eq((-SLEEF_INFINITY_F).as_vf()) |
				(a.lt((0.).as_vf()) & visint_vo_vf(a)) |
		   (visnumber_vo_vf(a) & a.lt((0.).as_vf()) & visnan_vo_vf(r));
  r = vsel_vf_vo_vf_vf(o, SLEEF_NAN_F.as_vf(), r);

  o = (a.eq(SLEEF_INFINITY_F.as_vf()) | visnumber_vo_vf(a)) &
				  a.ge((-f32::MIN).as_vf()) &
		    (a.eq((0.).as_vf()) | a.gt((36.).as_vf()) | visnan_vo_vf(r));
...
pub fn xerff_u1(a: VFloat) -> VFloat {
  ...
  a = vabs_vf_vf(a);
  VOpMask o0 = a.lt((1.1).as_vf());
  VOpMask o1 = a.lt((2.4).as_vf());
  VOpMask o2 = a.lt((4.).as_vf());
  ...
  u = vmulsign_vf_vf_vf(vsel_vf_vo_vf_vf(o2, d.0 + d.1, (1.).as_vf()), s);
...
pub fn xerfcf_u15(a: VFloat) -> VFloat {
  ...
  VFloat2 u, d, x;
  a = vabs_vf_vf(a);
  VOpMask o0 = a.lt((1.).as_vf());
  VOpMask o1 = a.lt((2.2).as_vf());
  VOpMask o2 = a.lt((4.3).as_vf());
  VOpMask o3 = a.lt((10.1).as_vf());
  ...
  x = dfmul_vf2_vf2_vf(vsel_vf2_vo_vf2_vf2(o1, d, vcast_vf2_vf_vf(-a, (0.).as_vf())), a);
  x = vsel_vf2_vo_vf2_vf2(o1, x, dfadd2_vf2_vf2_vf2(x, d));

  x = expk2f(x);
  x = vsel_vf2_vo_vf2_vf2(o1, x, dfmul_vf2_vf2_vf2(x, u));

  r = vsel_vf_vo_vf_vf(o3, x.0 + x.1, (0.).as_vf());
  r = vsel_vf_vo_vf_vf(vsignbit_vo_vf(s), (2.).as_vf() - r, r);
