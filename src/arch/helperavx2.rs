...
#[inline]
fn vreinterpret_vi2_vd(vd: VDouble) -> VInt2 { return _mm256_castpd_si256(vd); }
#[inline]
fn vreinterpret_vd_vi2(vi: VInt2) -> VDouble { return _mm256_castsi256_pd(vi); }
...
#[inline]
fn veq64_vo_vm_vm(x: VMask, y: VMask) -> VOpMask { return _mm256_cmpeq_epi64(x, y); }
#[inline]
...
#[inline]
fn vfmapp_vd_vd_vd_vd(x: VDouble, y: VDouble, z: VDouble) -> VDouble { return _mm256_fmadd_pd(x, y, z); }
#[inline]
fn vfmapn_vd_vd_vd_vd(x: VDouble, y: VDouble, z: VDouble) -> VDouble { return _mm256_fmsub_pd(x, y, z); }
#[inline]
fn vfmanp_vd_vd_vd_vd(x: VDouble, y: VDouble, z: VDouble) -> VDouble { return _mm256_fnmadd_pd(x, y, z); }
#[inline]
...
#[inline]
fn vsel_vi_vo_vi_vi(m: VOpMask, x: VInt, y: VInt) -> VInt { return _mm_blendv_epi8(y, x, _mm256_castsi256_si128(m)); }

#[inline]
fn vsel_vd_vo_vd_vd(o: VOpMask, x: VDouble, y: VDouble) -> VDouble { return _mm256_blendv_pd(y, x, _mm256_castsi256_pd(o)); }
#[inline]
fn vsel_vd_vo_d_d(o: VOpMask, v1: double, v0: double) -> VDouble { return _mm256_permutevar_pd(_mm256_set_pd(v1, v0, v1, v0), o); }
...
#[inline]
fn vgather_vd_p_vi(const double *ptr, VInt vi) -> VDouble { return _mm256_i32gather_pd(ptr, vi, 8); }
...
#[inline]
fn vcast_vi2_i(i: int) -> VInt2 { return _mm256_set1_epi32(i); }
#[inline]
...
#[inline]
fn vfmapp_vf_vf_vf_vf(x: VFloat, y: VFloat, z: VFloat) -> VFloat { return _mm256_fmadd_ps(x, y, z); }
#[inline]
fn vfmapn_vf_vf_vf_vf(x: VFloat, y: VFloat, z: VFloat) -> VFloat { return _mm256_fmsub_ps(x, y, z); }
#[inline]
...
#[inline]
fn vsub_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_sub_epi32(x, y); }
#[inline]
fn vneg_vi2_vi2(e: VInt2) -> VInt2 { return vsub_vi2_vi2_vi2(vcast_vi2_i(0), e); }

#[inline]
fn vand_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_and_si256(x, y); }
#[inline]
fn vandnot_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_andnot_si256(x, y); }
#[inline]
fn vor_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_or_si256(x, y); }
#[inline]
fn vxor_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_xor_si256(x, y); }
...
#[inline]
fn vsll_vi2_vi2_i(x: VInt2, c: int) -> VInt2 { return _mm256_slli_epi32(x, c); }
#[inline]
fn vsrl_vi2_vi2_i(x: VInt2, c: int) -> VInt2 { return _mm256_srli_epi32(x, c); }
#[inline]
fn vsra_vi2_vi2_i(x: VInt2, c: int) -> VInt2 { return _mm256_srai_epi32(x, c); }

#[inline]
fn veq_vo_vi2_vi2(VInt2 x, VInt2 y) -> VOpMask { return _mm256_cmpeq_epi32(x, y); }
#[inline]
fn vgt_vo_vi2_vi2(VInt2 x, VInt2 y) -> VOpMask { return _mm256_cmpgt_epi32(x, y); }
#[inline]
fn veq_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_cmpeq_epi32(x, y); }
#[inline]
fn vgt_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm256_cmpgt_epi32(x, y); }
...
#[inline]
fn vgather_vf_p_vi2(const float *ptr, VInt2 vi2) -> VFloat { return _mm256_i32gather_ps(ptr, vi2, 4); }
