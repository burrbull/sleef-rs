...
type VMask = __m128i;
type VOpMask = __m128i;

type VDouble = __m128d;
type VInt = __m128i;
...
#[inline]
fn vand_vm_vm_vm(x: VMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_and_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vandnot_vm_vm_vm(x: VMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_andnot_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vor_vm_vm_vm(x: VMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_or_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
...
#[inline]
fn vandnot_vm_vo64_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_andnot_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vor_vm_vo64_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_or_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vxor_vm_vo64_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_xor_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }

#[inline]
fn vand_vm_vo32_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_and_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vandnot_vm_vo32_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_andnot_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vor_vm_vo32_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_or_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
#[inline]
fn vxor_vm_vo32_vm(x: VOpMask, y: VMask) -> VMask { return vreinterpret_vm_vd(_mm_xor_pd(vreinterpret_vd_vm(x), vreinterpret_vd_vm(y))); }
...
#[inline]
fn vfmapp_vd_vd_vd_vd(x: VDouble, y: VDouble, z: VDouble) -> VDouble { return _mm_fmadd_pd(x, y, z); }
#[inline]
fn vfmapn_vd_vd_vd_vd(x: VDouble, y: VDouble, z: VDouble) -> VDouble { return _mm_fmsub_pd(x, y, z); }
#[inline]
fn vfmanp_vd_vd_vd_vd(x: VDouble, y: VDouble, z: VDouble) -> VDouble { return _mm_fnmadd_pd(x, y, z); }
#[inline]
...
#[inline]
fn vgather_vd_p_vi(const double *ptr, VInt vi) -> VDouble { return _mm_i32gather_pd(ptr, vi, 8); }
...
#[inline]
fn vrint_vi2_vf(vf: VFloat) -> VInt2 { return vcast_vi2_vm(_mm_cvtps_epi32(vf)); }
#[inline]
fn vtruncate_vi2_vf(vf: VFloat) -> VInt2 { return vcast_vi2_vm(_mm_cvttps_epi32(vf)); }
#[inline]
...
#[inline]
fn vfmapp_vf_vf_vf_vf(x: VFloat, y: VFloat, z: VFloat) -> VFloat { return _mm_fmadd_ps(x, y, z); }
#[inline]
fn vfmapn_vf_vf_vf_vf(x: VFloat, y: VFloat, z: VFloat) -> VFloat { return _mm_fmsub_ps(x, y, z); }
#[inline]
...
#[inline]
fn vsub_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm_sub_epi32(x, y); }
#[inline]
fn vneg_vi2_vi2(e: VInt2) -> VInt2 { return vsub_vi2_vi2_vi2(vcast_vi2_i(0), e); }

#[inline]
fn vand_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm_and_si128(x, y); }
#[inline]
fn vandnot_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm_andnot_si128(x, y); }
#[inline]
fn vor_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm_or_si128(x, y); }
#[inline]
fn vxor_vi2_vi2_vi2(VInt2 x, VInt2 y) -> VInt2 { return _mm_xor_si128(x, y); }
...
#[inline]
fn vsll_vi2_vi2_i(x: VInt2, c: int) -> VInt2 { return _mm_slli_epi32(x, c); }
#[inline]
fn vsrl_vi2_vi2_i(x: VInt2, c: int) -> VInt2 { return _mm_srli_epi32(x, c); }
#[inline]
fn vsra_vi2_vi2_i(x: VInt2, c: int) -> VInt2 { return _mm_srai_epi32(x, c); }
...
#[inline]
fn vgather_vf_p_vi2(const float *ptr, VInt2 vi2) -> VFloat { return _mm_i32gather_ps(ptr, vi2, 4); }
