...
static $ix2 vloadu_vi2_p(int32_t *p) { return _mm_loadu_si128((__m128i *)p); }
...
#[inline]
fn vand_vm_vm_vm(x: $mx, y: $mx) -> $mx { return _mm_and_si128(x, y); }
#[inline]
fn vandnot_vm_vm_vm(x: $mx, y: $mx) -> $mx { return _mm_andnot_si128(x, y); }
#[inline]
fn vor_vm_vm_vm(x: $mx, y: $mx) -> $mx { return _mm_or_si128(x, y); }
#[inline]
fn vxor_vm_vm_vm(x: $mx, y: $mx) -> $mx { return _mm_xor_si128(x, y); }

//#[inline]
//fn vand_vo_vo_vo(x: $mox, y: $mox) -> $mox { return _mm_and_si128(x, y); }
#[inline]
fn vandnot_vo_vo_vo(x: $mox, y: $mox) -> $mox { return _mm_andnot_si128(x, y); }
//#[inline]
//fn vor_vo_vo_vo(x: $mox, y: $mox) -> $mox { return _mm_or_si128(x, y); }
//#[inline]
//fn vxor_vo_vo_vo(x: $mox, y: $mox) -> $mox { return _mm_xor_si128(x, y); }
...
#else
#[inline]
fn vsel_vi_vo_vi_vi(m: $mox, x: $ix, y: $ix) -> $ix { return vor_vm_vm_vm(vand_vm_vm_vm(m, x), vandnot_vm_vm_vm(m, y)); }
...
#[inline]
fn vreinterpret_vf_vi2(vm: $ix2) -> $f32x { return _mm_castsi128_ps(vm); }
#[inline]
fn vreinterpret_vi2_vf(vf: $f32x) -> $ix2 { return _mm_castps_si128(vf); }
...
#[inline]
fn vabs_vf_vf(f: $f32x) -> $f32x { return vreinterpret_vf_vm(vandnot_vm_vm_vm(vreinterpret_vm_vf($f32x::splat(-0.)), vreinterpret_vm_vf(f))); }
...
#[inline]
fn vadd_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { $ix::from(x)+$ix::from(y) }
#[inline]
fn vsub_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { $ix::from(x)-$ix::from(y) }
#[inline]
fn vneg_vi2_vi2(e: $ix2) -> $ix2 { return vsub_vi2_vi2_vi2($ix2::from(0), e); }

#[inline]
fn vand_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return vand_vi_vi_vi(x, y); }
#[inline]
fn vandnot_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return vandnot_vi_vi_vi(x, y); }
#[inline]
fn vor_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return vor_vi_vi_vi(x, y); }
#[inline]
fn vxor_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return vxor_vi_vi_vi(x, y); }
...
#[inline]
fn visinf_vo_vf(d: $f32x) -> $mox { return vabs_vf_vf(d).ne($f32x::splat(SLEEF_INFINITY_F)); }
#[inline]
