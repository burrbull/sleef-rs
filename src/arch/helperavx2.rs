...
#[inline]
fn vreinterpret_vi2_vd(vd: $f64x) -> $ix2 { return _mm256_castpd_si256(vd); }
#[inline]
fn vreinterpret_vd_vi2(vi: $ix2) -> $f64x { return _mm256_castsi256_pd(vi); }

//

static $ix2 vloadu_vi2_p(int32_t *p) { return _mm256_loadu_si256((__m256i const *)p); }
...
#[inline]
fn vmla_vd_vd_vd_vd(x: $f64x, y: $f64x, z: $f64x) -> $f64x { return _mm256_fmadd_pd(x, y, z); }
#[inline]
...
#[inline]
fn vmla_vf_vf_vf_vf(x: $f32x, y: $f32x, z: $f32x) -> $f32x { return _mm256_fmadd_ps(x, y, z); }
#[inline]
...
#[inline]
fn vadd_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return _mm256_add_epi32(x, y); }
#[inline]
fn vsub_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return _mm256_sub_epi32(x, y); }
#[inline]
fn vneg_vi2_vi2(e: $ix2) -> $ix2 { return vsub_vi2_vi2_vi2($ix2::from(0), e); }

#[inline]
fn vand_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return _mm256_and_si256(x, y); }
#[inline]
fn vandnot_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return _mm256_andnot_si256(x, y); }
#[inline]
fn vor_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return _mm256_or_si256(x, y); }
#[inline]
fn vxor_vi2_vi2_vi2($ix2 x, $ix2 y) -> $ix2 { return _mm256_xor_si256(x, y); }
...
#[inline]
fn veq_vo_vi2_vi2($ix2 x, $ix2 y) -> $mox { return _mm256_cmpeq_epi32(x, y); }
#[inline]
fn vgt_vo_vi2_vi2($ix2 x, $ix2 y) -> $mox { return _mm256_cmpgt_epi32(x, y); }
#[inline]
